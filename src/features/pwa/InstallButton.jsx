...
export default function InstallButton({
  ...
  const { canInstall, isInstalled, showIOSGuide, setShowIOSGuide, promptInstall } =
    usePwaInstall();
  ...
  const baseStyles = {
    ...
    subtle: "inline-flex items-center gap-1.5 text-xs font-semibold text-[#1a3a8f] hover:text-indigo-900 hover:underline cursor-pointer",
  };
