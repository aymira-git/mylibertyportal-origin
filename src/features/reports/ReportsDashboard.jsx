...
export default function ReportsDashboard({
  ...
  const staffKpiStats = useMemo(() => {
    ...
    // Late arrivals today by WITA day boundary
          ...
          {(isActualAdmin || isAdminView) && (
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
              <div className="p-3.5 rounded-2xl bg-emerald-50/70 border border-emerald-100">
                ...
                <p className="text-2xl font-black text-emerald-950 mt-1">{staffKpiStats.onDutyCount}</p>
              ...
              <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200">
                ...
                <p className="text-2xl font-black text-slate-800 mt-1">{staffKpiStats.onLeaveCount}</p>
