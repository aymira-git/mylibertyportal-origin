...
function ClassesAndCoverageTab({ classes, users }) {
  ...
  }, [augmentedClasses, filter, search]);
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      {viewMode === "batches" ? (
        <AvailableBatches classes={classes} users={users} canEdit={false} role="manager" />
      ) : (
        <>
          {/* Header Banner */}
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
...
export default function ManagerDashboard() {
  ...
  const tabs = [
    ...
    },
    {
      ...
      component: <ClassesAndCoverageTab classes={classes} users={users} />,
    },
    {
      id: "reports",
