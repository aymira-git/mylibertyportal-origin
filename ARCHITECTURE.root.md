...
1. Read the active architecture guide.
...
For agent behavior and working rules, see [`CLAUDE.md`](./CLAUDE.md).

For the full audit procedure, see [`docs/audits/FULL_ARCHITECTURE_AUDIT.md`](./docs/audits/FULL_ARCHITECTURE_AUDIT.md).
